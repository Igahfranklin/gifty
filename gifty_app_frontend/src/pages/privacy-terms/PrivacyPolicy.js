  ...
  return (
    <section className="text-white">
      ...
      <div className="px-5 md:px-[3rem]">
        <h3>Last updated: June 12, 2021</h3>
        <br />
        <p>
        ...
        <br />
        <p>Tracking Technologies and Cookies</p> <br />
        <p>
        ...
        <p>Deletion of Your Personal Data</p> <br />
        <p>
        ...
        <br />
        <p>Transfer of Your Personal Data</p> <br />
        <p>
        ...
        <br />
        <p>Other legal requirements</p> <br />
        <p>
        ...
        <br />
        <p>Security of Your Personal Data</p> <br />
        <p>
        ...
        <br />
        <p>Links to Other Websites</p> <br />
        <p>
