      ...
      <div className="px-5 md:px-[3rem] bg-white py-[5.5rem]">
        ...
        <ul className="list-decimal ml-10">
          ...
          <li>
            ...
            “Us” or “Our” in this Agreement) refers to Saliech Ltd, 4th Floor,
            Tower C, Churchgate Plaza AO Cadastral Zone, Constitution Ave,
            900211, Abuja​.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Saliech websites, accessible from{" "}
            <a
              href="https://saliech.com/"
        ...
        <p className="py-2">Collecting and Using Your Personal Data</p>
        <p className="py-2">Types of Data Collected</p>
        <h3>3. Hazard Assessment and Worker Protections</h3>
        ...
        <p className="py-2">
          ...
          Your contact li associated with that account.
        </p>
        <p className="py-2">
        ...
        <ul className="list-decimal ml-10">
          ...
          <li>Information from your Device’s phone book (contacts li)</li>
          <li>
        ...
        <p className="py-2">Tracking Technologies and Cookies</p>
        <p className="py-2">
        ...
        <ul className="list-decimal ml-10">
          ...
          <li>
            ...
            <a
              ...
              target="_blank"
            >
              {/* Where_can_I_change_the_settings_for_disabling__or_deleting_local_
              shared_objects_ */}
            </a>
          </li>
          <li>
            <strong>Web Beacons.</strong> Certain s of our Service and our
            ...
            statistics (for example, recording the popularity of a certain and
        ...
        <p className="py-2">
          ...
          regarding cookies, please visit our Cookies Policy or the Cookies of
          our Privacy Policy.
        </p>
        <p className="py-2">Use of Your Personal Data</p>
        <p className="py-2">
        ...
        <p className="py-2">Retention of Your Personal Data</p>
        <p className="py-2">
        ...
        <p className="py-2">Deletion of Your Personal Data</p>
        <p className="py-2">
          The Company will only delete Your Personal Data before complete
          processing upon request. To request deletion of any/all Personal Data,
          inform us via email at
          <span>
            <strong>hello@saliech.com</strong>
          </span>
          using your registered email address. Your Personal Data will be
          removed from our storage systems no less than 3 months after receipt
          of your request.
        </p>{" "}
        <p className="py-2">Transfer of Your Personal Data</p>
        <p className="py-2">
        ...
        <p className="py-2">Disclosure of Your Personal Data</p>
        <p className="py-2">Business Transactions</p>
        <p className="py-2">
        ...
        <p className="py-2">Law enforcement</p>
        <p className="py-2">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>{" "}
        <p className="py-2">Other legal requirements</p>
        <p className="py-2">
          [Describe how workplace flow, such as signs and floor markings to
          indicate where employees and others should be located or their
          direction and path of travel, will be adjusted to ensure physical
          distancing.]
        </p>{" "}
        <p className="py-2">
        ...
        <p className="py-2">Security of Your Personal Data</p>
        <p className="py-2">
        ...
        <p className="py-2">Links to Other Websites</p>
        <p className="py-2">
        ...
        <ul className="list-decimal ml-10">
          <li>
            By email: <strong>hello@saliech.com</strong>
          </li>
          <li>
            By mail:{" "}
            <strong>
              4th Floor, Tower C, Churchgate Plaza AO Cadastral Zone,
              Constitution Ave, 900211, Abuja​
            </strong>
          </li>
        </ul>
      </div>
